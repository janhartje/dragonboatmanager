  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div key={evt.id} className="bg-white dark:bg-slate-900 p-4 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 hover:shadow-md transition-shadow">
                <div className="flex justify-between items-start mb-2">
                  <div>
                    ...
                    <div className="text-sm text-slate-500 dark:text-slate-400 flex items-center gap-1"><Calendar size={14} /> {new Date(evt.date).toLocaleDateString('de-DE')}</div>
                  </div>
      ...
      <div className="lg:col-span-2 space-y-6">
        {/* Paddler Form */}
        <div className={`p-6 rounded-xl shadow-sm border transition-all ${editingPaddlerId ? 'bg-orange-50 dark:bg-orange-900/20 border-orange-200 dark:border-orange-800 ring-1 ring-orange-200 dark:ring-orange-900' : 'bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800'}`}>
          ...
          <form onSubmit={handleSavePaddler} className="space-y-4">
            ...
            <div>
              <label className="text-[10px] uppercase font-bold text-slate-400 mb-2 block">Skills</label>
            ...
            <div className="flex gap-2 pt-2">
              ...
              <button type="submit" className={`text-white px-6 py-2 rounded text-sm font-medium flex items-center gap-2 ${editingPaddlerId ? 'bg-orange-500 hover:bg-orange-600' : 'bg-blue-600 hover:bg-blue-700'}`}>
